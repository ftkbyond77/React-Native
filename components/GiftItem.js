...
export default function GiftItem(props) {
    return (
        <View style={{  width: 350, height: 100, borderRadius: 15, alignSelf: "center", marginBottom: -40 }}>
            <View
                style={{
                    flexDirection: 'row',
                    alignItems: 'center',
                ...
                <View style={{ flex: 12 }}>
                    <TextInput value={props.item.title} placeholder="What's in your mind? " onChangeText={(new_title) => props.onUpdate(new_title, props.item.id)} style={{ color: "black" }} />
                </View>
